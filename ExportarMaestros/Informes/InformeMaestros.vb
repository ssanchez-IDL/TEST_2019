...
Public Class InformeMaestros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExportarMaestros.InformeMaestros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeMaestros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeMaestros = New InformeMaestros()
        rpt.Site = Me.Site
        Return rpt
    End Function
